...
(async () => {
  ...
  for (const relative of ['package.json','main.cjs','preload.cjs','bridge.cjs','sql-editor-main.cjs','ui/index.html','ui/styles.css','ui/execution.css','ui/query-form.js','ui/renderer.js','ui/sql-editor.js','ui/sql-editor.css']) {
